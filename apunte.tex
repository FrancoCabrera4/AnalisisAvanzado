...
\usepackage[graf, intHoriz, sinLU]{../../latex_common/caratula_uba/caratula}
...
\integrante{Franco Cabrera}{}{https://github.com/FrancoCabrera4}
\titulo{Análisis avanzado - Apuntes}
\fecha{\today}
\materia{Análisis avanzado}
...
El objetivo de estas notas es construir y consolidar a nivel más profundo los contenidos vistos en esta materia. Por lo tanto no está escrito de una forma particularmente pedagógica, sino más bien está más cerca de una enumeración de los resultados y teoremas más destacables, obviando algunos de menor talla. De cualquier forma, al momento de escribir esto, no me consta la existencia de un apunte de esta materia "hecho y derecho", así que no me parecería descabellado pensar que podría evolucionar en eso. Por eso invito a cualquier estudiante que lo lea y quiera contribuír que haga una pull request al repo que sera bienvenida.
